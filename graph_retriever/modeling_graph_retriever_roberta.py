...
from modules.roberta_iter_models import IterRobertaModelForRetrievalV3
...
class RobertaForGraphRetrieverIterV3(IterRobertaModelForRetrievalV3):

    def __init__(self, config: RobertaConfig, graph_retriever_config):
        super(RobertaForGraphRetrieverIterV3, self).__init__(config)
