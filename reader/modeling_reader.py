...
from modules.roberta_iter_models import IterRobertaModel, IterRobertaPreTrainedConfig
...
class IterRobertaForQuestionAnsweringConfidence(IterRobertaModel):

    def __init__(self, config: IterRobertaPreTrainedConfig, no_masking, lambda_scale=1.0):
        super().__init__(config)
